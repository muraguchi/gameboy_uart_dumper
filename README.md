...
* HuC-3 <br> Robot ponkkotu sun/star/moon version and so on. It is similar to HuC-1. HuC-3 has an infrared port as well as HuC-1. HuC-3 has RTC function.
* TAMA5 <br> Tamagocchi3. Only Tamagocchi3 uses this type. This dumper supports Tamagocchi3 with correct checksum.
* MMM01 <br> Momotarou collection 2 and so on. This type has multiple images in one cartridge. Multiple dumping (each title and title selection program) will be required to dump it out. In this dumper version global checksum fails. but it works on mgba emulator.
